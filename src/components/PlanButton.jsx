...
export default function PlanButton({ price, handlePlanSelection, presentPlan, ...plan }) {
  return (
  <button onClick={() => handlePlanSelection(plan.name)} className={`border-[1px] transition-all ${presentPlan === plan.name ? "bg-Magnolia border-Purplish-blue" : "" } flex-1 flex md:flex-col hover:border-Purplish-blue gap-3 rounded-lg p-4 border-Light-gray`}>
