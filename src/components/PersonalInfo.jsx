            ...
            <form className="flex flex-col gap-6">
                <label htmlFor="name"> 
                    <div className="flex items-center justify-between">
                        <span className="text-Marine-blue text-sm">Name</span>
                        <p className={`font-semibold ${isEmpty.name ? "hidden" : ""} text-Strawberry-red text-sm`}>This field is required</p>
                    </div>
                    <input
                ...
                <label htmlFor="email">
                    <div className="flex items-center justify-between">
                        <span className="text-Marine-blue text-sm">Email Address</span>
                        <p className={`font-semibold ${isEmpty.email ? "hidden" : ""} text-Strawberry-red text-sm`}>This field is required</p>
                    </div>
                    <input
                ...
                <label htmlFor="phone">
                    <div className="flex items-center justify-between">
                        <span className="text-Marine-blue text-sm">Phone Number</span>
                        <p className={`font-semibold ${isEmpty.phone ? "hidden" : ""} text-Strawberry-red text-sm`}>This field is required</p>
                    </div>
                    <input
